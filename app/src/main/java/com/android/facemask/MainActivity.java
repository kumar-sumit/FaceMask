...
import com.android.facemask.camera.CameraSourcePreview;
import com.android.facemask.camera.GraphicOverlay;
...
//            return;
    ...
    private FaceDetector createFaceDetector(Context context) {
        ...
        options.outHeight = 106;
        final Bitmap goggleImage = BitmapFactory.decodeResource(getResources(), R.drawable.glasses1, options);
